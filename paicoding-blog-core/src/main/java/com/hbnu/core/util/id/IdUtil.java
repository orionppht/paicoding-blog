package com.hbnu.core.util.id;

import com.hbnu.core.async.AsyncUtil;
import com.hbnu.core.util.CompressUtil;
import com.hbnu.core.util.id.snowflake.PaiSnowflakeIdGenerator;
import com.hbnu.core.util.id.snowflake.SnowflakeProducer;

import static com.hbnu.core.util.CompressUtil.int2str;
